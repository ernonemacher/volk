 ...
 * Squad Lane Solver
 *
 * Copied verbatim from SquadCalc's `src/js/squadLaneSolver.js` (dev branch),
 * MIT Non-Commercial, (c) Maxime "sharkman" Boussard. It was written with no
 * Leaflet, no DOM and no App singleton precisely so it can run anywhere, so it
 * is taken as-is rather than reimplemented: any divergence here would show up
 * as the bot disagreeing with beta.squadcalc.app about the same match.
 *
 *
